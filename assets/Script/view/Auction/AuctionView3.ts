...
@ccclass
export default class AuctionView3 extends cc.Component {
    ...
    onEnable()
    {
        EventManager.instance.addEventListener("rspMyAuctionSaleList", this.onRspAuctionSaleList, this)
    ...
    reqAuctionSaleList()
    {
        ...
        EventManager.instance.dispatchEvent("reqAuctionSaleList")
            ...
            EventManager.instance.dispatchEvent(EventEnum.SHOW_POPUP,{
                ...
                exData:{
                    ...
                    callback: (bagItemData)=>{
                        EventManager.instance.dispatchEvent(EventEnum.SHOW_POPUP,{
                            viewName: PrefabPathEnum.AuctionSaleView,
                            exData:{
                                auctionData: null,
                                isSelect: true,
